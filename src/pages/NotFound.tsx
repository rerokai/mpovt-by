...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background">
      <div className="glass-card p-10 max-w-md text-center animate-bounce-in">
        <h1 className="text-9xl font-bold text-primary mb-4 animate-glow">404</h1>
        ...
        <Button asChild className="btn-primary animate-bounce-in" style={{ animationDelay: '300ms' }}>
          <Link to="/">
